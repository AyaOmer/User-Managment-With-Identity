...
namespace UserManagmentWithIdentity.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<IdentityRole> _userStore;
        ...
        public ExternalLoginModel(
            ...
            IUserStore<IdentityRole> userStore,
        ...
        private IdentityRole CreateUser()
        {
            try
            {
        ...
        private IUserEmailStore<IdentityRole> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<IdentityRole>)_userStore;
        }
    }
}
